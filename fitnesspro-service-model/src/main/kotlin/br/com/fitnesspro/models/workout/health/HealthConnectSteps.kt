...
@Entity
@Table(
    name = "health_connect_steps",
    indexes = [
        Index(name = "idx_health_connect_steps_metadata_id", columnList = "health_connect_metadata_id"),
        Index(name = "idx_health_connect_steps_exec_exec_id", columnList = "exercise_execution_id") // NOVO ÍNDICE
    ]
)
