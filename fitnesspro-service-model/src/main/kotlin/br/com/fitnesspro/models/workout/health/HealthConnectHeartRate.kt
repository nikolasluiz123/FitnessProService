...
@Entity
@Table(
    name = "health_connect_heart_rate",
    indexes = [
        Index(name = "idx_health_connect_heart_rate_metadata_id", columnList = "health_connect_metadata_id"),
        Index(name = "idx_health_connect_heart_rate_exec_exec_id", columnList = "exercise_execution_id")
    ]
)
