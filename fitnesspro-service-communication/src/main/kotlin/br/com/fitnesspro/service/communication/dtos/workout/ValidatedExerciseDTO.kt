...
data class ValidatedExerciseDTO(
    ...
    @field:Schema(description = "Observação", example = "Observação sobre o exercício", required = false)
    @field:Size(max = 4096, message = "exerciseDTO.observation.size")
    override var observation: String? = null,

    @field:Schema(description = "Ordem do exercício no treino", example = "1", required = true)
    ...
    @field:Schema(description = "DTO para atualização das informações do Grupo Muscular do Exercício. É opcional pois há cenários onde não vamos processar o grupo, apenas o exercício.", required = false)
