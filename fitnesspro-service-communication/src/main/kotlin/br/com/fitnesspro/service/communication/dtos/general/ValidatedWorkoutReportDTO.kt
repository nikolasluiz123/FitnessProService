...
@Schema(description = "Classe DTO usada para vincular os relatórios do módulo de treinamento a um treino")
data class ValidatedWorkoutReportDTO(
    ...
    @field:NotNull(message = "workoutReportDTO.active.notNull")
