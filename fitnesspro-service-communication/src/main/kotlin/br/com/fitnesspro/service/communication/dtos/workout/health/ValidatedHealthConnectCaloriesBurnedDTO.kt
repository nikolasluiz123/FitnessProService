...
@Schema(description = "DTO para registros de calorias queimadas do Health Connect")
data class ValidatedHealthConnectCaloriesBurnedDTO(
    ...
    @field:NotNull(message = "healthConnectCaloriesBurned.active.notNull")
    override var active: Boolean = true,

    @field:Schema(description = "ID dos metadados associados", required = true)
    @field:NotNull(message = "healthConnectCaloriesBurned.healthConnectMetadataId.notNull")
    @field:Size(min = 1, max = 255, message = "baseDTO.id.size")
    ...
    @field:Schema(description = "Calorias em Kcal", required = true)
    @field:NotNull(message = "healthConnectCaloriesBurned.caloriesInKcal.notNull")
    @field:Min(value = 1, message = "healthConnectCaloriesBurned.caloriesInKcal.min")
    override var caloriesInKcal: Long? = null,

    @field:Schema(description = "Início do período", required = true)
    @field:NotNull(message = "healthConnectCaloriesBurned.startTime.notNull")
    @field:PastOrPresent(message = "healthConnectCaloriesBurned.startTime.pastOrPresent")
    override var startTime: Instant? = null,

    @field:Schema(description = "Fim do período", required = true)
    @field:NotNull(message = "healthConnectCaloriesBurned.endTime.notNull")
    @field:PastOrPresent(message = "healthConnectCaloriesBurned.endTime.pastOrPresent")
...
) : IHealthConnectCaloriesBurnedDTO