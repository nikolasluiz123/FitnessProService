...
@Schema(description = "DTO para registros de passos do Health Connect")
data class ValidatedHealthConnectStepsDTO(
    ...
    @field:NotNull(message = "healthConnectSteps.active.notNull")
    override var active: Boolean = true,

    @field:Schema(description = "ID dos metadados associados", required = true)
    @field:NotNull(message = "healthConnectSteps.healthConnectMetadataId.notNull")
    @field:Size(min = 1, max = 255, message = "baseDTO.id.size")
    ...
    @field:Schema(description = "Contagem de passos", required = true)
    @field:NotNull(message = "healthConnectSteps.count.notNull")
    @field:Min(value = 1, message = "healthConnectSteps.count.min")
    override var count: Long? = null,

    @field:Schema(description = "Início do período", required = true)
    @field:NotNull(message = "healthConnectSteps.startTime.notNull")
    @field:PastOrPresent(message = "healthConnectSteps.startTime.pastOrPresent")
    override var startTime: Instant? = null,

    @field:Schema(description = "Fim do período", required = true)
    @field:NotNull(message = "healthConnectSteps.endTime.notNull")
    @field:PastOrPresent(message = "healthConnectSteps.endTime.pastOrPresent")
