...
class ExerciseService(
    ...
    @ImportationEntity(entitySimpleName = "Exercise")
    ...
    @ImportationEntity(entitySimpleName = "ExerciseExecution")
    ...
    @ImportationEntity(entitySimpleName = "ExercisePreDefinition")
